...
function StorySection({ title, content }: StorySectionProps) {
  ...
  return (
    <div
      ref={ref}
      // Added min-h-[100dvh], w-full, and snap-center for full-page scroll locking
      className={`min-h-[100dvh] w-full flex flex-col items-center justify-center snap-center px-4 transition-all duration-1000 ease-out ${
        isVisible
          ? 'opacity-100 translate-y-0 scale-100'
    ...
    >
      {/* Outer wrapper for the glowing background effect */}
      <div className="relative max-w-3xl w-full group mx-auto">
