...
function FinalSurprise({ images = [] }: Props) {
  ...
  const defaultCaptions = [
    ...
    "Hey neek gurthundha… 4-1 hall tickets teeskunna tarwatha, nenu tea ki veldhama ani adiga… and we ended up having allam chai. ☕🌧️ Aaroju rain kooda padindhi… and everything felt a little more calm and perfect. Manam exact ga em matladamo gurthuledu, kani chala sepe unnam and the best part is, I never felt bored even for a sec. 🌸",
